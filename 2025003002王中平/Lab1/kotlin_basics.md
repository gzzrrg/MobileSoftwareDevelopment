...
fun main() {
    ...
    printWangzhongpingWeather("Cape Town", 59, 64, 2)
    printWangzhongpingWeather("Guatemala City", 50, 55, 7)
}

fun printWangzhongpingWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City: $city")
